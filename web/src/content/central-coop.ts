import type { Deck } from "@/components/SlideDeck";

/** The five ways into this folder. Each one is its own page. */
export const PARTS = [
  {
    slug: "brand",
    title: "Brand & identity",
    blurb: "The system the office went out into the world with.",
  },
  {
    slug: "social",
    title: "Social media",
  ...
  },
  {
    ...
    blurb: "Four guides built on one template.",
  },
  {
    slug: "editorial",
